...
do ie3=kfts,kfte -1
    do ie2=jfts, jfte -1
        do ie1=ifts, ifte -1
            ...
            K(ie1  ,ie3+1,ie2  , 1) =   K(ie1  ,ie3+1,ie2  , 1) + Kloc( 3,  3)
            K(ie1  ,ie3+1,ie2  , 2) =   K(ie1  ,ie3+1,ie2  , 2) + Kloc( 3,  4)
            K(ie1  ,ie3+1,ie2  , 7) =   K(ie1  ,ie3+1,ie2  , 7) + Kloc( 3,  5)
            K(ie1  ,ie3+1,ie2  , 8) =   K(ie1  ,ie3+1,ie2  , 8) + Kloc( 3,  6)
            K(ie1  ,ie3+1,ie2  ,10) =   K(ie1  ,ie3+1,ie2  ,10) + Kloc( 3,  7)
            K(ie1  ,ie3+1,ie2  ,11) =   K(ie1  ,ie3+1,ie2  ,11) + Kloc( 3,  8)
            K(ie1+1,ie3+1,ie2  , 1) =   K(ie1+1,ie3+1,ie2  , 1) + Kloc( 4,  4)
            K(ie1+1,ie3+1,ie2  , 6) =   K(ie1+1,ie3+1,ie2  , 6) + Kloc( 4,  5)
            K(ie1+1,ie3+1,ie2  , 7) =   K(ie1+1,ie3+1,ie2  , 7) + Kloc( 4,  6)
            K(ie1+1,ie3+1,ie2  , 9) =   K(ie1+1,ie3+1,ie2  , 9) + Kloc( 4,  7)
            K(ie1+1,ie3+1,ie2  ,10) =   K(ie1+1,ie3+1,ie2  ,10) + Kloc( 4,  8)
            K(ie1  ,ie3  ,ie2+1, 1) =   K(ie1  ,ie3  ,ie2+1, 1) + Kloc( 5,  5)
            K(ie1  ,ie3  ,ie2+1, 2) =   K(ie1  ,ie3  ,ie2+1, 2) + Kloc( 5,  6)
            K(ie1  ,ie3  ,ie2+1, 4) =   K(ie1  ,ie3  ,ie2+1, 4) + Kloc( 5,  7)
            K(ie1  ,ie3  ,ie2+1, 5) =   K(ie1  ,ie3  ,ie2+1, 5) + Kloc( 5,  8)
            K(ie1+1,ie3  ,ie2+1, 1) =   K(ie1+1,ie3  ,ie2+1, 1) + Kloc( 6,  6)
            K(ie1+1,ie3  ,ie2+1, 3) =   K(ie1+1,ie3  ,ie2+1, 3) + Kloc( 6,  7)
            K(ie1+1,ie3  ,ie2+1, 4) =   K(ie1+1,ie3  ,ie2+1, 4) + Kloc( 6,  8)
